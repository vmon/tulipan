...
const unsigned int C_L_SHA::sm_K160[4] =
{
	0x5A827999, 0x6ED9EBA1, 0x8F1BBCDC, 0xCA62C1D6
};

const unsigned int C_L_SHA::sm_H160[SHA160LENGTH] =
{
	0x67452301, 0xEFCDAB89, 0x98BADCFE, 0x10325476, 0xC3D2E1F0
};

const unsigned int C_L_SHA::sm_K256[64] =
{
...
const unsigned int C_L_SHA::sm_H256[SHA256LENGTH] =
{
	0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a,
	0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19
};

const SUI64 C_L_SHA::sm_H384[SHA512LENGTH] =
{
...
const SUI64 C_L_SHA::sm_K512[80] =
{
...
const SUI64 C_L_SHA::sm_H512[SHA512LENGTH] =
{
...
C_L_SHA::C_L_SHA(int iMethod)
{
	...
	switch(iMethod)
	{
		...
		{
/*			ostrstream ostr;
			ostr << "FileDigest ERROR: in C_L_SHA() Constructor, Illegal Method " << iMethod << "!" << ends;
...
void C_L_SHA::AddData(char const* pcData, int iDataLength)
{
	if(iDataLength < 0) int a = 2;
//		throw runtime_error(string("FileDigest ERROR: in C_L_SHA::AddData(), Data Length should be >= 0!"));
	unsigned int uiT;
	switch(m_iMethod)
	{
		case SHA160:
...
void C_L_SHA::FinalDigest(char* pcDigest)
{
	//Is the User's responsability to ensure that pcDigest is properly allocated 20, 32,
	//48 or 64 bytes, depending on the method
	if(false == m_bAddData) int a = 2;
//		throw runtime_error(string("FileDigest ERROR: in C_L_SHA::FinalDigest(), No data Added before call!"));
	switch(m_iMethod)
	{
		case SHA160:
		case SHA256:
